...
<div id="admin-body">
    <div class="container">
        <div class="wrapper">
            <div class="header">
                <div class="logo">
                    <img src="<?= $asset->baseUrl ?>/img/small-logo.png">
                    <div class="short-title">Polyana Fest</div>
                </div>
                <div class="nav">
                    ...
                    <ul class="nav navbar-nav pull-right">
                        <li class="dropdown language-switch">
                            <a class="dropdown-toggle" data-toggle="dropdown">
                                <img src="<?= $asset->baseUrl ?>/img/flags/<?= Yii::$app->language ?>.png" class="position-left" alt="">
                                <?= \yii\easyii\components\helpers\LanguageHelper::getLanguages()[Yii::$app->language] ?>
                            ...
                            <ul class="dropdown-menu">
                                <li>
                                    <a href="<?= Url::current(['language' => 'uk']) ?>">
                                        <img src="<?= $asset->baseUrl ?>/img/flags/uk.png" alt=""> Украинский
                                    </a>
                                </li>
                                <li>
                                    <a href="<?= Url::current(['language' => 'en']) ?>">
                                        <img src="<?= $asset->baseUrl ?>/img/flags/en-US.png" alt=""> English
                                    </a>
                                </li>
                            </ul>
                        </li>
